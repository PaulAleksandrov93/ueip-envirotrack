...
//         <button onClick={handleCreateMeasuringInstrument} className="create-standard-link">Добавить СИ</button>
//       </div>
      
//       {isCreating && <MeasuringInstrumentForm onCloseForm={handleCloseForm} />}
//       {editingMeasuringInstrumentId && <MeasuringInstrumentForm instrumentId={editingMeasuringInstrumentId} onCloseForm={handleCloseForm} />}
//     </div>
//   );
// };
